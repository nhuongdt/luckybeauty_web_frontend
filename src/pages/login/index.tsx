      ...
      <Container className="d-flex align-items-center justify-content-center vh-100">
        <Row className="align-items-center justify-content-center">
          <Col>
            ...
            >
              <Image width={'64px'} height={'64px'} style={{margin: '24px 244px'}} src='../../images/Lucky_beauty.jpg'/>
              <label className='login-label' style={{margin:'12px 128px',height:'42px',width:'295px', fontSize:'32px',lineHeight:'42px', textAlign:'center',color: '#333233'}}>Đăng nhập</label>
              <Form onSubmit={handleSubmit} noValidate >
                ...
                <Form.Group>
                  <Row>
                    <Col className='float-left'>
                      <Form.Check className='input-check'
                        checked={remember}
                        type={'checkbox'}
                        label={`Ghi nhớ`}
                        onClick={()=>{
                    ...
                    <Col className='float-right'>
                      <Form.Text className="form-text-float-right">
                        <a href='#' className='a'>Quên mật khẩu</a>
                      </Form.Text>
                    </Col>
                  </Row>
                </Form.Group>
                ...
                <label className='login-label' style={{margin:'12px 128px',height:'20px',width:'295px', fontSize:'14px',lineHeight:'20px',alignContent:'center', textAlign:'center', alignItems:'center'}}>Tổng đài hỗ trợ : 0247 303 9333 - 0936 363 069</label>
                <p className='login-label' style={{margin:'12px 128px',height:'20px',width:'295px', fontSize:'14px',lineHeight:'20px',alignContent:'center', textAlign:'center', alignItems:'center'}}>Bạn chưa có tài khoản? <a className='a'>Đăng ký</a></p>
              </Form>
            </div>
          </Col>
        </Row>
