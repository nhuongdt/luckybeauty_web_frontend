...
const CreateOrEditRole = ({ visible, onCancel,modalType, onOk, permissions }: ICreateOrEditRoleProps) => {
        ...
        <Tabs defaultActiveKey={"role"} size={"small"} tabBarGutter={64}>
          ...
          <div style={{ display: "flex", flexDirection: "column" }}>
            ...
            <div style={{ marginBottom: 16 }}>
              <Input placeholder="Search" size="large"  value={searchValue} onChange={handleSearchChange} />
            </div>
