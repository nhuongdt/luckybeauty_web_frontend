    ...
    return (
      <div className="container-fluid h-100 bg-light">
          ...
          >
            ...
            <div>
              ...
              >
                ...
                <Button className="btn btn-add-item" onClick={()=>{this.resetData(); this.onOpenDialog()}}>Thêm nhân viên</Button>
              </Stack>
            </div>
          </Stack>
        </div>
              ...
              {this.state.listNhanVien.map((item, index) => {
                return (
                  <tr key={index}>
                    ...
                    <td className="text-td-table"><></><CalendarMonthIcon fontSize="small"/> {new Date(item.ngaySinh).toLocaleDateString('en-GB')}</td>
                    <td className="text-td-table">
        ...
        <CreateOrEditNhanVienDialog
          ...
          createOrEditNhanSu={this.state.createOrEditNhanSu}
        ></CreateOrEditNhanVienDialog>
